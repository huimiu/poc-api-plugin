...
## Known issues
Currently, this project is unable to run successfully because the Teams manifest schema hasn't been finalized yet. As a result, some actions in the teamsapp.local.yaml and teamsapp.yaml files may fail to execute, such as `validateManifest`, `validateAppPackage` and `extendToM365`.
